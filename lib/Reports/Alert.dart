...
class AlertReport extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
         title:const Text("Alert Report",style:TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
...
showDialog(
  ...
  builder: (context) {
    return AlertDialog(
      title: const Text('Alert Report Filter',style: TextStyle(fontSize: 18)),
      content: const AlertFilterDialogContent(),
      actions: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
